...
namespace LapShop.Migrations
{
    ...
    [Migration("20250415140410_init_database_representation")]
    partial class init_database_representation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LapShop.Models.BusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.CashTransaction", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.CustomerxItem", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.DeliveryMan", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.Item", b =>
                {
                    b.Property<int>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Models.ItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.ItemImage", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.ItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Models.OperatingSystem", b =>
                {
                    b.Property<int>("OperatingSystemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Models.PurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.PurchaseInvoicexItem", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.SalesInvoice", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.SalesInvoicexItem", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.Slider", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Models.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Models.CustomerxItem", b =>
                {
                    ...
                    b.HasOne("LapShop.Models.Item", "Item")
                        .WithMany("CustomerxItems")
            ...
            modelBuilder.Entity("LapShop.Models.Item", b =>
                {
                    b.HasOne("LapShop.Models.Category", "Category")
                        .WithMany("Items")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LapShop.Models.ItemType", "ItemType")
                        .WithMany("Items")
                        .HasForeignKey("ItemTypeId");

                    b.HasOne("LapShop.Models.OperatingSystem", "OperatingSystem")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("LapShop.Models.PurchaseInvoice", b =>
                {
                    b.HasOne("LapShop.Models.Supplier", "Supplier")
            ...
            modelBuilder.Entity("LapShop.Models.PurchaseInvoicexItem", b =>
                {
                    ...
                    b.HasOne("LapShop.Models.PurchaseInvoice", "PurchaseInvoice")
                        .WithMany("PurchaseInvoicexItems")
            ...
            modelBuilder.Entity("LapShop.Models.SalesInvoice", b =>
                {
                    ...
                    b.HasOne("LapShop.Models.DeliveryMan", "DeliveryMan")
                        .WithMany("SalesInvoices")
            ...
            modelBuilder.Entity("LapShop.Models.SalesInvoicexItem", b =>
                {
                    ...
                    b.HasOne("LapShop.Models.SalesInvoice", "SalesInvoice")
                        .WithMany("SalesInvoicexItems")
